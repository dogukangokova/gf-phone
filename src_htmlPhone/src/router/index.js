...
const AppStoreChannel = () => import('@/components/AppStore/AppStoreChannel')
const AppStore = () => import('@/components/AppStore/AppStore')
...
const Spotify = () => import('@/components/Spotify/Spotify')
...
export default new Router({
  routes: [
    ...
    },
    {
      ...
      path: '/appstore/:channel',
      name: 'appstore.channel.show',
      component: AppStore
    }, {
      path: '/appstore',
      name: 'appstore',
      component: AppStoreChannel
    }, {
      path: '/appels',
      name: 'appels',
      component: Appels
