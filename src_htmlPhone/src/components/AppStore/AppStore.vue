<template>
  ...
  >
    ...
    <div class="phone_content">
      ...
      >
        <div
          v-for="(elem) in appstoreMessages"
          :key="elem.id"
          class="element"
        >
          <div class="time">
...
export default {
  ...
  computed: {
    ...mapGetters(['appstoreMessages', 'Apps', 'appstoreCurrentChannel', 'useMouse']),
    channelName() {
      return '# ' + this.channel
    }
  },
  ...
  methods: {
    setChannel(channel) {
      ...
      this.appstoreSetChannel({channel})
    },
    ...mapActions(['appstoreSetChannel', 'appstoreSendMessage']),
    ...
    onQuit() {
      this.$router.push({name: 'appstore.channel'})
    },
    formatTime(time) {
